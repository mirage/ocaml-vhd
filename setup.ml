...
(* OASIS_START *)
(* DO NOT EDIT (digest: 13e096a944dace883a0d405a6456cc6d) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "vm_test.ml"; });
               Test
                 ({
                     cs_name = "parse_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\250\229eTp\222\151\251\237#\205\141m\241\164\141";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
