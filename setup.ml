...
(* OASIS_START *)
(* DO NOT EDIT (digest: ffb6d055aee0b4abc7ac8bd004963b6a) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Vhd_lwt"; "Memory"; "File"; "Patterns_lwt"; "Block"
                        ];
                      lib_pack = false;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\138W\031<\243\022\242Y\139\203<\0293S\214\254";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
