...
(* OASIS_START *)
(* DO NOT EDIT (digest: f3e959315c21213f057a0851dbcc9b42) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Vhd"; "S"; "Vhd_result"; "Element"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "vhd-format";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Vhd_lwt"; "Memory"; "File"];
                      lib_pack = false;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\203\178\138:\249\195\225x\196jp\026\161'\161\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
